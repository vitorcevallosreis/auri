...
// renderizava sem sidebar e com métricas fictícias hardcoded (ver
// ./viewModel/DashboardViewModel.ts) — era o que dava a impressão de "front
// deturpado" logo após o login.
//
